...
$ cellranger count --id=SRR1 \  # 这个是相对路径输出文件夹，随便写
                   ...
                   --create-bam false #更新后一定要写这个选项了，我也不知道为什么
                   --sample=mysample \  # fastq文件夹中待分析的样本名前缀

cellranger count --id SRR1  --transcriptome ~/software/refdata-gex-GRCh38-2020-A  --fastqs ~/dbgap/data/SRR21407771  --create-bam false --sample SRR21407771  #这个是我用的一个例子
